...
from src.utils.config import config, LOADOUTS_FILE, COMPONENT_FILE
    ...
    with tab1:
        ...
        with col1:
            ...
            if new_title != loadout['title']:
                ...
                if config.save_json_data(LOADOUTS_FILE, loadouts_data):
        ...
        for comp_type, comp_key in zip(COMPONENT_FILE.keys(), loadout['components'].keys()):
